...
import RespiratoryGraph from "../Components/RespiratoryGraph";
    ...
    <div className="tw-flex tw-flex-col tw-bg-black tw-min-h-screen">
      ...
      <div className="tw-flex-1 tw-ml-64 tw-p-4 tw-text-white tw-space-y-4">
        ...
        <div className="tw-grid tw-grid-cols-1 tw-gap-4">
          ...
          <div className="tw-bg-gray-800 tw-p-4 tw-rounded-lg tw-h-[600px]">
            <SleepTimeline />
          </div>
          
        </div>
        <div className="tw-bg-gray-800 tw-p-4 tw-rounded-lg tw-h-[460px]">
            <RespiratoryGraph />
        </div>
